                    ...
                    children: <Widget>[
                      InkWell(
                        child: Text(
                          ...
                          style: TextStyle(fontSize: 20, color: Colors.red), // Change the color of the link to red
                        ),
                        onTap: () async {
                      ...
                      Text(
                        ...
                        style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white), // Change the color of the text to white
                      ),
                      SizedBox(height: 20),
                      Text(
                        ...
                        style: TextStyle(fontSize: 20, color: Colors.white), // Change the color of the text to white
                      ),
                    ],
                  ),
                ),
